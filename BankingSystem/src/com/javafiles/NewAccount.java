...
java.sql.Connection c;
			...
			ps.executeUpdate();
			PreparedStatement ps1=c.prepareStatement("select * from accountdata where accountno='"+res1+"'");
